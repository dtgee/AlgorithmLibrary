...
public class RotatedBinarySearch
{
	public static void generateTests()
	{
		...
		test1[0] = 3; test1[1] = 4; test1[2] = 5; test1[3] = -5;
		test1[4] = -4; test1[5] = -3; test1[6] = -2;
		...
		for (int i = 0; i < test1.length; i++)
			stringList += test1[i] + " ";
		System.out.println("The list is: " + stringList + "   Our element is: " + element);
		
		long startTime = System.nanoTime();
	
		boolean status = rotatedBinarySearch(test1, element, 0, test1.length - 1);
		
		long endTime = System.nanoTime();
		long duration = (endTime - startTime);
		double seconds = (double) (duration / 1000000000.0);
		
		String output = "The expected result of this " + BinarySearch.class.getSimpleName() + " is: " + doesContain + "" +
	...
	public static boolean rotatedBinarySearch(int[] array, int element, int low, int high)
	{
		int mid = (low + high) / 2;
    ...
    public static boolean rotatedBinarySearch(int[] array, int element, int low, int high)
    {
	    ...
	    else
	    {
	        ...
	        return (rotatedBinarySearch(array, element, low, mid) ||
	        		rotatedBinarySearch(array, element, mid + 1, high));
	    }
    }
    */
