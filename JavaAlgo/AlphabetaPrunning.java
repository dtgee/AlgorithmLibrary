...
public class AlphabetaPrunning 
{
	...
	//Opponents best move. CITED FROM the TA's white-board drawings (Stellyanos) and 
	...
	public int alphabeta(GameState inState, int depth, int alpha, int beta)     
	{
		...
		{   
			...
			//evaluation technique. It's lengthy, so thats why its stored in a method.
	...
	//This needs to be in a separate method because the evaluation is so lengthy.
