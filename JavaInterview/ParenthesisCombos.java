...
public class ParenthesisCombos {
	 ...
	 * 
	 * 
	 * This solution builds up the combos and prints
	 * them. The time complexity is O(2^n)
	 * 
	 * Can further optimize by using a char[] array 
	 * instead of attempting to O(n^2) concatenating str's.
	 * 
	 */
