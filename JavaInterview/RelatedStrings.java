...
public class RelatedStrings {
	/*
	 *  Given an array of strings, find the string which is 
	 *  made up of maximum number of other strings contained 
	 *  in the same array. 
	 *         
	 ...
	 * 	
	 *  Implemented via Rabin-Karp, borrowed from princeton.edu
	 *  ^ NEVERMIND, that algorithm has too much overhead.
	 * 
	 */
	...
	public static void main(String[] args) {
		...
		String[] list = { "rat", "cat", "abc", "xyz", "abcxyz", 
